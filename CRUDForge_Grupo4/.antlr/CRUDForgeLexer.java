...
public class CRUDForgeLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"ENTITY", "FIELDS", "INDEXES", "API", "UI", "WITH", "GENERATE", "FULL", 
			"BASIC", "PAGINATION", "SEARCH", "FILTERS", "SORTABLE", "UUID", "STRING", 
			"INT", "DECIMAL", "BOOL", "DATE", "REFERENCE", "PK", "REQUIRED", "MIN", 
			"DEFAULT", "UNIQUE", "GT", "LT", "COLON", "COMMA", "EQUAL", "NUMBER", 
	...
	public CRUDForgeLexer(CharStream input) {
		super(input);
